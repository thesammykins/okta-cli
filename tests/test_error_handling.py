...
def test_list_users_unauthorized_error(mock_get, mock_config):
    ...
    mock_response.text = '{"errorCode": "E0000011", "errorSummary": "Invalid token provided"}'
...
def test_list_users_not_found_error(mock_get, mock_config):
    ...
    mock_response.text = '{"errorCode": "E0000007", "errorSummary": "Not found: Resource not found"}'
    mock_get.return_value = mock_response
...
def test_list_users_rate_limit_error(mock_get, mock_config):
    ...
    mock_response.text = '{"errorCode": "E0000047", "errorSummary": "API call exceeded rate limit"}'
...
def test_list_users_server_error(mock_get, mock_config):
    ...
    mock_response.text = '{"errorCode": "E0000009", "errorSummary": "Internal Server Error"}'
    mock_get.return_value = mock_response
